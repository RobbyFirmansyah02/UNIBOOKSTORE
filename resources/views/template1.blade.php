...
<body>
    ...
    <div id="app">
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        <li class="sidebar-title text-center">Main Menu</li>
                        <hr>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ route('kategori.index') }}" class="submenu-link">Tabel Buku</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ route('buku.index') }}" class="submenu-link">Tabel Penerbit</a>
        ...
        <div id="main">
            <header class="mb-3">
                <nav class="navbar navbar-expand navbar-light navbar-top p-0 pb-4">
